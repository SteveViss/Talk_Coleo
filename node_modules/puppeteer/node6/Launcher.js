...
class Launcher {
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      const connection = (yield Connection.create(browserWSEndpoint, connectionDelay));
   ...
   * @return {!Promise<!Browser>}
   */
  static /* async */ connect({browserWSEndpoint, ignoreHTTPSErrors = false}) {return (fn => {
  const gen = fn.call(this);
  return new Promise((resolve, reject) => {
    function step(key, arg) {
      let info, value;
    ...
    const connection = (yield Connection.create(browserWSEndpoint));
