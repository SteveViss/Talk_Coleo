...
class Frame {
  ...
  return new Promise((resolve, reject) => {
    ...
    const remoteObject = (yield this._rawEvaluate(pageFunction, ...args));
  ...
  return new Promise((resolve, reject) => {
    ...
    const remoteObject = (yield this._rawEvaluate(selector => document.querySelector(selector), selector));
    if (remoteObject.subtype === 'node')
      return new ElementHandle(this, this._client, remoteObject, this._mouse, this._touchscreen);
    (yield helper.releaseObject(this._client, remoteObject));
    return null;
  });}
  ...
  return new Promise((resolve, reject) => {
    ...
    const result = (yield this.evaluate(pageFunction, ...args));
  ...
  return new Promise((resolve, reject) => {
    ...
    const remoteObject = (yield this._rawEvaluate(selector => Array.from(document.querySelectorAll(selector)), selector));
   ...
   * @return {!Promise<(!Object|undefined)>}
   */
  /* async */ _rawEvaluate(pageFunction, ...args) {return (fn => {
  const gen = fn.call(this);
  return new Promise((resolve, reject) => {
    function step(key, arg) {
      let info, value;
...
class WaitTask {
  ...
  return new Promise((resolve, reject) => {
    ...
    let error = null;
    try {
      success = (yield this._frame.evaluate(this._pageScript));
    } catch (e) {
      error = e;
    }
 ...
 */
/* async */ function waitForPredicatePageFunction(predicateBody, polling, timeout) {return (fn => {
  const gen = fn.call(this);
  return new Promise((resolve, reject) => {
    function step(key, arg) {
      let info, value;
